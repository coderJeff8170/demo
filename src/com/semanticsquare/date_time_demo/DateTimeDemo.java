package com.semanticsquare.date_time_demo;
...
public class DateTimeDemo {
    ...
    private static void testDateTimeAPI() {
        ...
        System.out.println("newExpiryDate is after expiry date?: " + newExpiryDate.isAfter(expiryDate));
        System.out.println("newExpiryDate is before expiry date?: " + newExpiryDate.isBefore(expiryDate));
        ...
        System.out.println("today is in period?" + today);
